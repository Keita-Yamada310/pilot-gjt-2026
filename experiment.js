...
timeline.push({
  ...
  pages: [
    ...
    `<div class="gjt-card">
      <h2>回答上の注意</h2>
      <p>文の内容ではなく、英語の文法としての正しさを判断してください。</p>
...
function makeJudgmentTrial(isPractice = false) {
  return {
        ...
        <div class="gjt-card">
          ...
          <div class="scale-wrap">
            <div class="gjt-label-row">
              <span class="label-left">英語の文法として<br>明らかに間違っている</span>
    ...
    button_html: function(choice, choiceIndex) {
      ...
      const wrapperStyle = isFourth
        ? "display:flex;align-items:center;margin-left:48px;position:relative;"
        : "display:flex;align-items:center;position:relative;";

      const divider = isFourth
        ? `<span aria-hidden="true"
             style="position:absolute;left:-25px;top:7px;width:1px;height:54px;background:#b8c2cc;"></span>`
        : "";
